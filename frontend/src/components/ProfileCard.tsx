        ...
        <>
            {loading ? (
                ...
                <div className="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
                    <div className="border-b px-4 pb-6" style={{ borderColor: 'pink', borderWidth: '2px', borderRadius: '12px' }}>
                        <div className="text-center my-4">
                            ...
                            <div className="py-2">
                                <h3 className="font-bold text-2xl text-gray-800 dark:text-white mb-1">{user?.firstName}</h3>
